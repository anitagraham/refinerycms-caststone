...
ActiveRecord::Schema.define(:version => 20140514052915) do

  create_table "refinery_caststone_assignments", :force => true do |t|
    t.integer "component_id_id"
    t.integer "photo_id_id"
  end

  create_table "refinery_caststone_components", :force => true do |t|
    t.string   "name"
    t.string   "type"
    t.string   "note"
    t.integer  "height"
  ...
  create_table "refinery_caststone_photos", :force => true do |t|
    t.string   "name"
    t.string   "caption"
    t.integer  "image_uid"
    t.text     "drawing"
  ...
  create_table "refinery_caststone_products", :force => true do |t|
    t.string   "name"
    t.text     "blurb"
    t.boolean  "buildable"
    t.integer  "position"
