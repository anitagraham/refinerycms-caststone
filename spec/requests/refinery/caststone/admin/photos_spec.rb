...
#
        # describe "photos list" do
          # before(:each) do
            # FactoryBot.create(:photo, name: "UniqueTitleOne")
            # FactoryBot.create(:photo, name: "UniqueTitleTwo")
          # end
#
...
#
          # context "duplicate" do
            # before(:each) { FactoryBot.create(:photo, name: "UniqueTitle") }
#
            # it "should fail" do
              # visit refinery.caststone_admin_photos_path
#
...
#
        # describe "edit" do
          # before(:each) { FactoryBot.create(:photo, name: "A name") }
#
          # it "should succeed" do
            # visit refinery.caststone_admin_photos_path
#
...
#
        # describe "destroy" do
          # before(:each) { FactoryBot.create(:photo, name: "UniqueTitleOne") }
#
          # it "should succeed" do
            # visit refinery.caststone_admin_photos_path
#
